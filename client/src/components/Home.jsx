    ...
    <>
      <div className='Home md:mx-10 lg:mx-10'>
        ...
        <div className='flex justify-center items-center'>
          ...
          <div className='p-2 lg:p-9 bg-white mt-[-95px] md:mt-[-155px] lg:mt-[-155px] w-[88vw] md:w-[70vw] lg:w-[70vw] relative z-10 border rounded-xl flex gap-2 md:gap-4 lg:gap-4 justify-center'>
